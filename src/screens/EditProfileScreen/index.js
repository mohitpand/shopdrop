...
import { View, TouchableOpacity, Text, Dimensions, ScrollView, ImageBackground } from 'react-native';
        ...
        return (
            <ImageBackground source={require('../../assets/images/backgroundImage.png')} style={{ flex: 1 }}>
                ...
                <ScrollView style={styles.mainContainer}>
                    <Text style={styles.fullnametextstyle}>FULL NAME</Text>
                    <TextBox
                        placeholder={'Name'}
                        textInputStyle={styles.textboxStyle}
                    ...
                    <Text style={styles.fullnametextstyle}>DATE OF BIRTH</Text>
                    <TextBox
                        placeholder={'Date'}
                        textInputStyle={styles.textboxStyle}
                    ...
                    <Text style={styles.fullnametextstyle}>EMAIL</Text>
                    <TextBox
                        placeholder={'Email'}
                        keyboardType={'email'}
                        textInputStyle={styles.textboxStyle}
                    ...
                    <Text style={styles.fullnametextstyle}>MOBILE NUMBER</Text>
                    <TextBox
                    ...
                    <Text style={styles.fullnametextstyle}>LOCATION</Text>
                    <TextBox
